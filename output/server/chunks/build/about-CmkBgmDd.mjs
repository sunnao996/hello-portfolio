import { q as queryCollection, _ as _sfc_main$3$1, a as _sfc_main$2$1, b as _sfc_main$5 } from './client-nMb__N-H.mjs';
import { _ as _sfc_main$4 } from './ColorModeAvatar-D4e1kZzX.mjs';
import { defineComponent, withAsyncContext, unref, withCtx, createVNode, createBlock, openBlock, Fragment, renderList, computed, watch, mergeProps, h, getCurrentInstance, toRaw, reactive, resolveComponent, defineAsyncComponent, Text, Comment, useSSRContext } from 'vue';
...
import { ssrRenderComponent, ssrRenderList, ssrRenderSlot, ssrRenderAttrs, ssrRenderAttr, ssrInterpolate } from 'vue/server-renderer';
import { a as useAsyncData, c as createError, b as useAppConfig, d as useSeoMeta } from './server.mjs';
...
const __nuxt_component_0 = Object.assign(_sfc_main$3, { __name: "MDCRenderer" });
const _sfc_main$2 = {
  __name: "MDC",
  ...
  async setup(__props) {
    ...
    const { data, refresh, error } = ([__temp, __restore] = withAsyncContext(async () => useAsyncData(key.value, async () => {
      ...
      const { parseMarkdown } = await import('./index-7aZg8we9.mjs').then((n) => n.i);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><img${ssrRenderAttr("src", __props.image.src)}${ssrRenderAttr("alt", __props.image.alt)} class="size-32 object-cover"><span class="w-32 text-xs text-black font-serif font-medium text-center mt-2">${ssrInterpolate(__props.image.alt)}</span></div>`);
    };
  }
});
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    let __temp, __restore;
    const { data: page } = ([__temp, __restore] = withAsyncContext(() => useAsyncData("about", () => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UColorModeAvatar = _sfc_main$4;
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_MDC, {
                      value: unref(page).content,
                      unwrap: "p"
                    }, null, _parent3, _scopeId2));
                    _push3(`<div class="flex flex-row justify-center items-center py-10 space-x-[-2rem]"${_scopeId2}><!--[-->`);
                    ssrRenderList(unref(page).images, (image, index) => {
                      _push3(ssrRenderComponent(_component_PolaroidItem, {
                        key: index,
                        image,
                        index
                      }, null, _parent3, _scopeId2));
                    ...
                    return [
                      ...
                      createVNode("div", { class: "flex flex-row justify-center items-center py-10 space-x-[-2rem]" }, [
                        (openBlock(true), createBlock(Fragment, null, renderList(unref(page).images, (image, index) => {
                          return openBlock(), createBlock(_component_PolaroidItem, {
                            key: index,
                            image,
                            index
                          }, null, 8, ["image", "index"]);
...
export { htmlTags as a, about as b, find as f, html as h, normalize as n, svg as s };
//# sourceMappingURL=about-CmkBgmDd.mjs.map
