...
export const patternBackgroundVariants = cva('relative', {
  variants: {
    variant: {
      [PATTERN_BACKGROUND_VARIANT.Grid]:
        'bg-[linear-gradient(to_right,rgba(0,0,0,0.1)_1px,transparent_1px),linear-gradient(to_bottom,rgba(0,0,0,0.1)_1px,transparent_1px)] dark:bg-[linear-gradient(to_right,rgba(255,255,255,0.1)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.1)_1px,transparent_1px)]',
      [PATTERN_BACKGROUND_VARIANT.Dot]:
        'bg-[radial-gradient(rgba(0,0,0,0.1)_1px,transparent_1px)] dark:bg-[radial-gradient(rgba(255,255,255,0.1)_1px,transparent_1px)]',
      [PATTERN_BACKGROUND_VARIANT.BigDot]:
        'bg-[radial-gradient(rgba(0,0,0,0.1)_3px,transparent_3px)] dark:bg-[radial-gradient(rgba(255,255,255,0.1)_3px,transparent_3px)]'
    },
    size: {
      xs: 'bg-[size:8px_8px]',
...
export { default as PatternBackground } from '@/components/PatternBackground.vue'
